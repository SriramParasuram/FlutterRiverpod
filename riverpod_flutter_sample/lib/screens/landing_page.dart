...
import 'package:flutter_hooks_riverpod_app/features/my_location/location_screen.dart';
import 'package:flutter_hooks_riverpod_app/features/products/ui/products_screen.dart';
import 'package:flutter_hooks_riverpod_app/screens/ipo_screen.dart';
import 'package:flutter_hooks_riverpod_app/screens/price_screen.dart';
import 'package:flutter_hooks_riverpod_app/watchlist/screens/watchlist_screen.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:hooks_riverpod/hooks_riverpod.dart';
import '../MyCounter/my_counter_screen.dart';
    ...
    final List<_LandingTile> tiles = [
      ...
      _LandingTile(
        ...
        onTap:
            () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) =>  MyCounterScreen()), // you'll create this
        ),
      ),
      ...
      //       () => Navigator.push(
      //     context,
      //     MaterialPageRoute(builder: (_) =>  IpoScreenBloc()), // you'll create this
      //   ),
      // )
      ...
      //       () => Navigator.push(
      //     context,
      //     MaterialPageRoute(builder: (_) =>  LocationScreen()), // you'll create this
      //   ),
      // ),
